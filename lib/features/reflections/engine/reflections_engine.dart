...
class ReflectionsEngine {
  ...
  final keywords = [
    'siempre', 'nunca', 'tengo que', 'debería', 'cansancio', 'descanso',
  ];
  final keywordCounts = {
  ...
  final List<ReflectionCard> cards = [
    ...
    ReflectionCard(
      ...
      hallazgo: 'El lunes te sentías diferente a hoy. Nota cómo ha cambiado tu lenguaje emocional.',
      perspectivaHumanista: 'La resiliencia se construye reconociendo los matices de cada día.',
      accionConsciente: 'Hoy, intenta no usar la palabra "debería".',
      arquetipo: arquetipo,
    ),
    ReflectionCard(
      titulo: 'Sabiduría de tu Sombra',
      hallazgo: 'He notado que cuando hablas de ciertas personas o situaciones, tu lenguaje se vuelve evasivo.',
      perspectivaHumanista: 'El autoconocimiento surge cuando abrazamos tanto la luz como la sombra.',
      accionConsciente: 'Escribe una frase donde reconozcas una emoción difícil sin juzgarla.',
      arquetipo: arquetipo,
    ),
  ];
